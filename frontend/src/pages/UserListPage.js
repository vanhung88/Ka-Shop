...
const UserListPage = ({ history }) => {
  ...
  return (
    <div className="wrap-list-users">
      ...
      <hr />
      <h1
        style={{ textAlign: 'center', fontWeight: '500', padding: '20px 0px' }}
      >
        Users information
      </h1>
      {loading ? (
          ...
          <thead>
            <tr>
              ...
              <th style={{ fontSize: '15px' }}>
                <i className="fas fa-key" style={{ paddingRight: '10px' }} />
                ID
              </th>
              <th style={{ fontSize: '15px' }}>
                <i className="fas fa-user" style={{ paddingRight: '10px' }} />
                NAME
              </th>
              <th style={{ fontSize: '15px' }}>
                <i
              ...
              <th style={{ fontSize: '15px', textAlign: 'center' }}>
                <i className="fas fa-cogs" style={{ paddingRight: '10px' }} />
                SETTING
              </th>
            </tr>
          </thead>
                  ...
                  {!user.isAdmin ? (
                    <>
                      ...
                      <i
                        ...
                        style={{ paddingLeft: '10px', color: '#D32F41' }}
      ...
      >
        <Modal.Header>
          <Modal.Title>KALLES STORE</Modal.Title>
        </Modal.Header>
        <Modal.Body>Are you sure delete it?</Modal.Body>
        <Modal.Footer>
